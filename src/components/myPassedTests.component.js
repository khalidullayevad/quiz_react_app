...
export default class AllTests extends Component {
  ...
  componentDidMount() {
    ...
    QuizzesServer.getAllPassedTests().then((res)=>{
  ...
  renderQuizzes = quize =>{
    return <tr>
         ...
         <td><button class="btn btn-success mb-4"  onClick={()=>this.cardView(quize.questionForm.id)}>Pass the test again</button>  </td>   
          </tr>
  }
  render() {
